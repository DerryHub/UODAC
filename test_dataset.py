...
from src.dataset import CocoDataset, Resizer, Normalizer, collater
...
def test(opt):
    test_set = CocoDataset(opt.data_path, set='val2017', transform=transforms.Compose([Normalizer(), Resizer()]))
    ...
    for i, data in enumerate(progress_bar):
        ...
        for j, output in enumerate(output_list):
            ...
            if writePIC:
                ...
                cv2.imwrite("{}/{}_prediction.jpg".format(opt.prediction_dir, image_info["file_name"][:-4]), output_image)
